...
{
    public static class PurchaseAgreementAuthorPredicate
    {
        public static Expression<Func<Purchase_Agreement, bool>> GetPurchaseAgreementAuthorPredicate(Expression<Func<Purchase_Agreement, bool>> predicate, List<ERoleType> roleList, int currentUserId = -1)
        {
            var predicateInner = PredicateBuilder.New<Purchase_Agreement>(predicate);
