...
!function (e) {
    "function" == typeof define && define.amd
        ? define(["kendo.core.min"], e)
        : e()
}(function () {
    var e;
    e = window.kendo.jQuery,
        kendo.ui.FlatColorPicker && (
            kendo.ui.FlatColorPicker.prototype.options.messages = e.extend(!0, kendo.ui.FlatColorPicker.prototype.options.messages, {
                apply: "Áp dụng",
                cancel: "Hủy",
        ...
        kendo.ui.ColorPicker && (
            kendo.ui.ColorPicker.prototype.options.messages = e.extend(!0, kendo.ui.ColorPicker.prototype.options.messages, {
                apply: "Áp dụng",
                cancel: "Hủy",
                noColor: "không màu sắc",
                clearColor: "Loại bỏ màu sắc"
        ...
        kendo.ui.DateRangePicker && (
            kendo.ui.DateRangePicker.prototype.options.messages = e.extend(!0, kendo.ui.DateRangePicker.prototype.options.messages, {
                startLabel: "Bắt đầu",
                endLabel: "Kết thúc"
            })
        ),
        kendo.ui.Editor && (
            kendo.ui.Editor.prototype.options.messages = e.extend(!0, kendo.ui.Editor.prototype.options.messages, {
                ...
                overwriteFile: 'Một tập tin có tên "{0}" đã tồn tại tại thư mục hiện tại. Bạn có muốn ghi đè n' +
                    'ó không?',
        ...
        kendo.ui.FileBrowser && (
            kendo.ui.FileBrowser.prototype.options.messages = e.extend(!0, kendo.ui.FileBrowser.prototype.options.messages, {
                ...
                overwriteFile: 'Một tập tin có tên "{0}" đã tồn tại ở thư mục hiện tại. Bạn có muốn ghi đè nó ' +
                    'không?',
        ...
        kendo.ui.FilterCell && (
            kendo.ui.FilterCell.prototype.options.messages = e.extend(!0, kendo.ui.FilterCell.prototype.options.messages, {
                isTrue: "là đúng",
                isFalse: "là sai",
                filter: "Bộ lọc",
                clear: "Loại bỏ",
        ...
        kendo.ui.Groupable && (
            kendo.ui.Groupable.prototype.options.messages = e.extend(
                !0,
        ...
        kendo.ui.NumericTextBox && (
            kendo.ui.NumericTextBox.prototype.options = e.extend(!0, kendo.ui.NumericTextBox.prototype.options, {
        ...
        kendo.spreadsheet && kendo.spreadsheet.messages.borderPalette && (
        ...
        kendo.spreadsheet && kendo.spreadsheet.messages.dialogs && (
            kendo.spreadsheet.messages.dialogs = e.extend(!0, kendo.spreadsheet.messages.dialogs, {
                ...
                useKeyboardDialog: {
                    ...
                    errorMessage: "Những thao tác này không thể gọi qua trình đơn. Thay vào đó, vui lòng sử dụng " +
                        "phím tắt:",
                    labels: {
        ...
        kendo.spreadsheet && kendo.spreadsheet.messages.filterMenu && (
        ...
        kendo.spreadsheet && kendo.spreadsheet.messages.colorPicker && (
            kendo.spreadsheet.messages.colorPicker = e.extend(!0, kendo.spreadsheet.messages.colorPicker, {
                reset: "Thiết lập lại màu sắc",
        ...
        kendo.spreadsheet && kendo.spreadsheet.messages.toolbar && (
        ...
        kendo.spreadsheet && kendo.spreadsheet.messages.view && (
            kendo.spreadsheet.messages.view = e.extend(!0, kendo.spreadsheet.messages.view, {
                errors: {
                    shiftingNonblankCells: "Không thể chèn các ô do nguy cơ mất dữ liệu. Chèn vào vị trí khác hoặc xóa dữ " +
                        "liệu từ cuối trang tính",
        ...
        kendo.ui.Slider && (
            kendo.ui.Slider.prototype.options = e.extend(!0, kendo.ui.Slider.prototype.options, {
                increaseButtonTitle: "Tăng",
                decreaseButtonTitle: "Giảm"
            })
        ),
        kendo.ui.AutoComplete && (
        kendo.ui.AutoComplete.prototype.options.messages = e.extend(!0, kendo.ui.AutoComplete.prototype.options.messages, {
        ...
        kendo.ui.TreeView && (
            kendo.ui.TreeView.prototype.options.messages = e.extend(!0, kendo.ui.TreeView.prototype.options.messages, {
                loading: "Đang tải...",
                requestFailed: "Yêu cầu thất bại.",
                retry: "Thử lại"
            })
        ...
        kendo.ui.Upload && (
            kendo.ui.Upload.prototype.options.localization = e.extend(!0, kendo.ui.Upload.prototype.options.localization, {
                ...
                retry: "Thử lại",
                remove: "Xóa bỏ",
                clearSelectedFiles: "Xóa tất cả",
                uploadSelectedFiles: "Tải lên các tập tin",
        ...
        kendo.ui.Validator && (
            kendo.ui.Validator.prototype.options.messages = e.extend(!0, kendo.ui.Validator.prototype.options.messages, {
                ...
                pattern: "Định dạng không hợp lệ",
                min: "Giá trị nên lớn hơn hoặc bằng {1}",
                max: "Giá trị nên nhỏ hơn hoặc bằng {1}",
                step: "Giá trị không hợp lệ",
        ...
        kendo.ui.progress && (
            kendo.ui.progress.messages = e.extend(!0, kendo.ui.progress.messages, { loading: "Đang tải..." })
        ),
        kendo.ui.Dialog && (
            kendo.ui.Dialog.prototype.options.messages = e.extend(!0, kendo.ui.Dialog.prototype.options.localization, { close: "Đóng" })
        ),
        kendo.ui.Calendar && (
            kendo.ui.Calendar.prototype.options.messages = e.extend(!0, kendo.ui.Calendar.prototype.options.messages, { weekColumnHeader: "", today: "Hôm nay" })
        ),
        kendo.ui.Alert && (
            kendo.ui.Alert.prototype.options.messages = e.extend(!0, kendo.ui.Alert.prototype.options.localization, { okText: "Đồng ý" })
        ),
        kendo.ui.Confirm && (
            kendo.ui.Confirm.prototype.options.messages = e.extend(!0, kendo.ui.Confirm.prototype.options.localization, {
                okText: "Đồng ý",
                cancel: "Hủy"
            })
        ),
        kendo.ui.Prompt && (
            kendo.ui.Prompt.prototype.options.messages = e.extend(!0, kendo.ui.Prompt.prototype.options.localization, {
                okText: "Đồng ý",
                cancel: "Hủy"
            })
        ),
        ...
        kendo.ui.DropDownList && (
            kendo.ui.DropDownList.prototype.options.messages = e.extend(!0, kendo.ui.DropDownList.prototype.options.messages, {
                noData: "Không có dữ liệu", clear: "Xóa"
            })
        ),
        kendo.ui.MultiSelect && (
            kendo.ui.MultiSelect.prototype.options.messages = e.extend(!0, kendo.ui.MultiSelect.prototype.options.messages, {
                noData: "Không có dữ liệu", clear: "Xóa"
            })
        ),
        kendo.mobile.ui.ListView && (
        kendo.mobile.ui.ListView.prototype.options.messages = e.extend(!0, kendo.mobile.ui.ListView.prototype.options.messages, {
            loadMoreText: "点击载入更多", pullTemplate: "下拉刷新", releaseTemplate: "释放刷新", refreshTemplate: "刷新中...", noRecords : "Không có dữ liệu"
        }))
});
