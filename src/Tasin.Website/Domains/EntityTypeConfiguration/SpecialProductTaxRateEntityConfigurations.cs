...
{
    public class SpecialProductTaxRateEntityConfigurations : IEntityTypeConfiguration<SpecialProductTaxRate>
    {
        public void Configure(EntityTypeBuilder<SpecialProductTaxRate> builder)
        {
            // Primary key
            ...
            // Table
            builder.ToTable("SpecialProductTaxRate");
        }
    }
}
