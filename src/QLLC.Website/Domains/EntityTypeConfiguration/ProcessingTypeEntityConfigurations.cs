...
{
    public class ProcessingTypeEntityConfigurations : IEntityTypeConfiguration<ProcessingType>
    {
        public void Configure(EntityTypeBuilder<ProcessingType> builder)
        {
            // Primary key
            ...
            // Table
            builder.ToTable("ProcessingType");
        }
    }
}
